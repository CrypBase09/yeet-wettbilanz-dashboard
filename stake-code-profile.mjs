...
export const stakeProfiles = [
  ...
  { amount: 0.69, aliases: [0.68], version: "V2", conviction: "High", stakeMode: "Research 25% V2", normalStake: 2.50, stakeFactor: 0.25, reductionReason: "Warning signal" },
  ...
  { amount: 3.00, version: "Special", conviction: "Special", stakeMode: "Special", strategyType: "Special", normalStake: 3.00, stakeFactor: null, reductionReason: "Outside focus strategy" },
